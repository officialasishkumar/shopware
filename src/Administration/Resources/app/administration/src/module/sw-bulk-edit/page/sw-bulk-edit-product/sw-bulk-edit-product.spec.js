...
describe('src/module/sw-bulk-edit/page/sw-bulk-edit-product', () => {
    ...
    it('should provide bulk-edit specific property empty-state copy', async () => {
        ...
        expect(wrapper.vm.propertyFormFields[0].config.emptyStateTitle).toBe('sw-bulk-edit.product.property.titleEmptyState');
        expect(wrapper.vm.propertyFormFields[0].config.emptyStateDescription).toBe('sw-bulk-edit.product.property.descriptionEmptyState');
    });
