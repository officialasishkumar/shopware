...
class VersionManagerTest extends TestCase
{
     ...
     */
    #[DataProvider('cloneOverwriteProvider')]
    public function testCloneEntityWithOverwrites(
     ...
     */
    public static function cloneOverwriteProvider(): iterable
    {
        // ListField replacement test
        yield 'ListField is replaced, not merged' => [
            ...
            // BUGGY: Using only array_replace_recursive gives ['value2', 'value2', 'value3']
        ...
        yield 'nested ListField inside JsonField is replaced, not merged' => [
            ...
            'expectedData' => [
                'container' => [
                    'name' => 'Container Name',
                    // BUGGY: Using only array_replace_recursive gives for nested structures,
                    // which incorrectly merges the ListField by index.
